...
CREATE DATABASE IF NOT EXISTS avalon;
...
INSERT INTO carrinho ('id', 'titulo', 'preco', 'quantidade', 'imagem') VALUES
('2', 'teste03', '35.99', '1', '/images/produtos/destaque-capa.png'),
('3', 'teste4', '35.99', '2', '/images/produtos/destaque-capa.png'),
('4', 'teste05', '35.99', '3', '/images/produtos/destaque-capa.png'),
('5', 'teste06', '35.99', '4', '/images/produtos/destaque-capa.png');
...
INSERT INTO livros (titulo, preco, acabamento, sinopse, isbn, idioma, ano, paginas, autores_id, editoras_id, categorias_id,capa,imagens) VALUES 
...
'9786555942491', 'Português', 2022,  200, 1, 1, 1, "./images\my broken mariko"),
...
DROP TABLE IF EXISTS livros_estoque;
...
DROP TABLE IF EXISTS livros_em_ofertas;
