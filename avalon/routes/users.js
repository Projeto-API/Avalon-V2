...
const validatorFormLogin = require("../middewres/validatorFormLogin");
...
router.post("/entrar", validatorFormLogin, LoginController.login);
...
router.post("/login", validatorFormLogin, AuthController.login);
router.post(
  "/forgot-password",
