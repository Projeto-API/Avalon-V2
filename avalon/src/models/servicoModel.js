...
module.exports = {
  ...
  createOne: (req) => {
    ...
    fs.writeFileSync(path.join(dirname, "../database/servicos.json"), JSON.stringify(servicos, null, 4))
  },
  findOne: (req) => {
  ...
  deleteOne: (req) => {
    ...
    fs.writeFileSync(path.join(dirname, "../database/servicos.json"), JSON.stringify(novoServicos, null, 4))
  },
  updateOne: (req) => {
