...
router.delete('/autores/deletar/:id', CategoriaController.deletar);
router.delete('/categorias/deletar/:id', CategoriaController.deletar);
router.delete('/editoras/deletar/:id', EditoraController.deletar);
